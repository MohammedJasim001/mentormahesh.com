...
import { BiDetail, BiHome } from "react-icons/bi";
...
const Nav = () => {
  ...
  return (
    ...
    >
      <div className=" mx-auto px-4 sm:px-6  lg:pr-20">
        <div className="flex justify-between items-center h-16">
          <div className=" flex items-center ">
            <img src="/icon.png" alt="" className="w-10 h-10 mr-2" />
            <h3 className="text-xl font-imprima text-orange-500 font-bold tracking-tighter">
              MENTOR MAHESH
            </h3>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#FFFDE7] border-t border-gray-200">
          {["home", "workshops", "lifestyle", "contact"].map((item) => (
            <a
              key={item}
              href={`#${item}`}
