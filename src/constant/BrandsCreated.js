export const BRANDS = [
  ...
  },
  {
    ...
    image: "toonland.png",
    description:
      "Toonland is a joyful world of storytelling, creativity, and comics that spark imagination and make learning fun. From thought-provoking toons to character-led narratives, we turn life lessons and ideas into playful, powerful visuals — for kids, teens, and the young-at-heart.",
  ...
  },
  {
    ...
    image: "al.png",
    description:
      "ActiveListeners is a safe, non-judgmental space where you can talk — and truly be heard. Whether you're navigating stress, confusion, loneliness, or just need to unburden — we’re here to listen with empathy, not advice. We’re not therapists. We’re real people trained to hold space, ask the right questions, and offer human connection in a noisy world.",
  ...
  },
  {
    ...
    image: "mythos.png",
    description:
      "A combination of  of PSYCHOLOGY + VEDIC ASTROLOGY Mythos isn’t just about reports; it’s a thriving community of individuals seeking purpose, clarity, and cosmic guidance. Whether you’re exploring astrology, psychology, or career growth, our groups help you connect with like-minded people who share your journey.",
