...
const Home = () => {
  return (
    <section className="min-h-screen bg-[#FFFDE7] flex items-center px-6 lg:px-16 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-8 max-w-xl font-semibold">
            A career mentor, executive search expert, founder of transformative
            communities like Propelling Stories, Story Club, Mentoons and
            Mentoons Mythos.
          </p>
